...
struct DeviceInfoMessage: Hashable, CustomStringConvertible {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> DeviceInfoMessage? {
    ...
    let deviceModel: String? = nilOrValue(pigeonVar_list[1])
  ...
  static func == (lhs: DeviceInfoMessage, rhs: DeviceInfoMessage) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.osVersion, rhs.osVersion) && MessagesPigeonInternal.deepEquals(lhs.deviceModel, rhs.deviceModel)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("DeviceInfoMessage")
  ...
  public var description: String {
    return "DeviceInfoMessage(osVersion: \(String(describing: osVersion)), deviceModel: \(String(describing: deviceModel)))"
  }
}
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? DeviceInfoMessage {
      super.writeByte(129)
...
class DeviceInfoHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: DeviceInfoHostApi?, messageChannelSuffix: String = "") {
    ...
    let getDeviceInfoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.device_info_plugin.DeviceInfoHostApi.getDeviceInfo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
