...
struct DeviceInfoIOS: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: DeviceInfoIOS, rhs: DeviceInfoIOS) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.deviceModel, rhs.deviceModel) && MessagesPigeonInternal.deepEquals(lhs.osVersion, rhs.osVersion)
  }
...
class DeviceInfoHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: DeviceInfoHostApi?, messageChannelSuffix: String = "") {
    ...
    let getDeviceInfoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.device_info_plugin_ios.DeviceInfoHostApi.getDeviceInfo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
