...
class DeviceInfoAndroid {
  ...
  static DeviceInfoAndroid decode(Object result) {
    result as List<Object?>;
    return DeviceInfoAndroid(
      deviceModel: result[0] as String?,
  ...
  bool operator ==(Object other) {
    if (other is! DeviceInfoAndroid || other.runtimeType != runtimeType) {
      return false;
    }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is DeviceInfoAndroid) {
      buffer.putUint8(129);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        return DeviceInfoAndroid.decode(readValue(buffer)!);
      default:
...
class DeviceInfoHostApi {
  ...
  Future<DeviceInfoAndroid> getDeviceInfo() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.device_info_plugin_android.DeviceInfoHostApi.getDeviceInfo$pigeonVar_messageChannelSuffix';
    ...
    ;
    return pigeonVar_replyValue! as DeviceInfoAndroid;
  }
}
